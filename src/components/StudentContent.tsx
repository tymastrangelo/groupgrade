  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full flex flex-col gap-8">
      <div className="flex flex-col gap-1">
        <h1 className="text-[#111318] text-4xl font-black tracking-tight">Welcome back, {userName}</h1>
      ...
      {!loading && classes.length === 0 ? (
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 lg:col-span-8 flex flex-col gap-6">
            <section className="bg-white rounded-xl p-6 shadow-sm border border-[#f0f2f4] flex flex-col gap-4">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h2 className="text-[#111318] text-xl font-bold tracking-tight">Join your first class</h2>
              ...
              {error && (
                <div className="flex items-center gap-2 text-red-600 text-sm font-semibold bg-red-50/20 border border-red-200 rounded-lg px-4 py-3">
              ...
              <div className="bg-primary/5/10 rounded-lg p-4 border border-primary/20 flex items-start gap-2 text-sm text-[#616f89]">
                <span className="material-symbols-outlined text-primary">info</span>
                <div>
                  <p className="font-semibold text-[#111318]">Need help?</p>
      ...
      {activeTab === 'classes' ? (
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 lg:col-span-8 flex flex-col gap-6">
            <section className="bg-white rounded-xl p-6 shadow-sm border border-[#f0f2f4]">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-[#111318] text-xl font-bold tracking-tight">Your Classes</h2>
              ...
              {error && (
                <div className="flex items-center gap-2 text-red-600 text-sm font-semibold bg-red-50/20 border border-red-200 rounded-lg px-4 py-3 mb-2">
                  <span className="material-symbols-outlined text-lg">error</span>
                  <span>{error}</span>
                </div>
              )}
                ...
                {loading ? (
                  ...
                  classes.map(cls => (
                    <Link
                      ...
                      className="bg-white rounded-lg border border-[#f0f2f4] p-4 hover:shadow-md transition-shadow block"
                    >
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          <p className="text-lg font-bold text-[#111318]">{cls.name}</p>
          ...
          <div className="col-span-12 lg:col-span-4 flex flex-col gap-6">
            <div className="bg-primary/5/10 rounded-xl p-6 border border-primary/20">
              ...
              <p className="text-xs text-[#616f89]">Ask your professor for the class join code. Codes expire after 14 days.</p>
            </div>
          </div>
        </div>
      ) : (
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 lg:col-span-8 flex flex-col gap-6">
            <section className="bg-white rounded-xl p-6 shadow-sm border border-[#f0f2f4]">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h2 className="text-[#111318] text-xl font-bold tracking-tight">Your Projects</h2>
                ...
                {projectsLoading ? (
                  ...
                  projects.map((p) => (
                    <Link
                      ...
                      className="p-4 rounded-xl border border-[#f0f2f4] bg-[#f9fafb] flex flex-col gap-2 hover:shadow-md transition-shadow"
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          ...
                          <div className="flex gap-2 mt-2 flex-wrap">
                            ...
                            <span className="text-[11px] px-2 py-1 rounded-full bg-[#f3f4f6] text-[#616f89]">
                        ...
                        {p.myGroupName ? (
                          ...
                          <span className="text-[11px] px-3 py-1 rounded-full bg-[#f3f4f6] text-[#616f89] font-bold">Not assigned</span>
                        )}
                      </div>
                      {p.myGroupName && p.myGroupMembers && (
                        <div className="border border-[#e5e7eb] rounded-lg p-3 bg-white">
                          <p className="text-sm font-semibold text-[#111318]">{p.myGroupName}</p>
                          <div className="flex flex-wrap gap-2 mt-2">
                            {p.myGroupMembers.map((m) => (
                              <span
                                key={m.id}
                                className="flex items-center gap-1 text-xs px-2 py-1 rounded-full bg-[#f3f4f6] text-[#111318] border border-[#e5e7eb]"
                              >
          ...
          <div className="col-span-12 lg:col-span-4 flex flex-col gap-6">
            <div className="bg-primary/5/10 rounded-xl p-6 border border-primary/20">
              ...
              <p className="text-xs text-[#616f89]">When professors create groups, your team appears here automatically.</p>
            </div>
          </div>
        </div>
      )}
