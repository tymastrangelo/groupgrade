export default function TeacherDashboard() {
  return (
    <>
      ...
      <div className="bg-[#f6f6f8] text-[#111318] min-h-screen flex">
        <aside className="w-64 border-r border-[#e5e7eb] bg-white hidden lg:flex flex-col fixed h-full z-20">
        ...
        <main className="flex-1 lg:ml-64 flex flex-col">
          <header className="h-16 border-b border-[#e5e7eb] bg-white px-8 flex items-center justify-between sticky top-0 z-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#111318] text-sm font-medium">Your Classes</span>
            </div>
            <div className="flex items-center gap-6">
              <div className="relative hidden md:block">
                ...
                <input className="bg-[#f3f4f6] border-none rounded-lg pl-10 pr-4 py-1.5 text-sm w-72 focus:ring-1 focus:ring-primary" placeholder="Search courses..." type="text"/>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-[#e5e7eb]">
                  <div className="flex flex-col text-right">
                    <span className="text-xs font-bold text-[#111318]">Dr. Julian Reed</span>
          ...
          <div className="p-8 max-w-[1400px] mx-auto w-full grid grid-cols-12 gap-8">
            <div className="col-span-12 xl:col-span-9 flex flex-col gap-6">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div className="flex gap-2">
                  <button className="bg-[#f0f2f4] px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2">
                    <span>Fall 2023</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-xl border border-[#e5e7eb] p-6 hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-xl font-bold text-[#111318] mb-1">CS402: Systems Design</h3>
                ...
                <div className="bg-white rounded-xl border border-[#e5e7eb] p-6 hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-xl font-bold text-[#111318] mb-1">PSY101: Intro to Psychology</h3>
                ...
                <div className="bg-white rounded-xl border border-[#e5e7eb] p-6 hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-xl font-bold text-[#111318] mb-1">DS500: Advanced Analytics</h3>
                ...
                <button className="border-2 border-dashed border-[#e5e7eb] rounded-xl p-6 flex flex-col items-center justify-center min-h-[220px] hover:bg-white hover:border-primary transition-all group">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <span className="material-symbols-outlined text-primary text-2xl">add</span>
                  </div>
                  <span className="text-base font-bold text-[#111318]">Create New Class</span>
                ...
                <div className="bg-white rounded-xl border border-[#e5e7eb] overflow-hidden">
                  <div className="divide-y divide-[#f0f2f4]">
                    <div className="p-5 flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-11 h-11 rounded-lg bg-orange-50/20 flex flex-col items-center justify-center shrink-0">
                        ...
                        <div className="flex flex-col">
                          <h4 className="text-sm font-bold text-[#111318]">Project Milestone 3: Implementation Plan</h4>
                          <p className="text-xs text-[#616f89] font-medium">CS402: Systems Design • 12/12 groups pending</p>
                        </div>
                      </div>
                      <button className="px-4 py-1.5 text-xs font-bold border border-[#e5e7eb] rounded-lg hover:bg-background-light transition-colors">Details</button>
                    </div>
                    <div className="p-5 flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-11 h-11 rounded-lg bg-blue-50/20 flex flex-col items-center justify-center shrink-0">
                        ...
                        <div className="flex flex-col">
                          <h4 className="text-sm font-bold text-[#111318]">Peer Evaluation Cycle 3</h4>
            ...
            <div className="col-span-12 xl:col-span-3 flex flex-col gap-6">
              <div className="bg-white rounded-xl border border-[#e5e7eb] overflow-hidden">
                <div className="bg-red-50/50/10 p-5 border-b border-[#e5e7eb]">
                  <div className="flex items-center gap-2">
                ...
                <div className="p-2 space-y-1">
                  <div className="p-4 hover:bg-background-light rounded-lg flex flex-col gap-2 cursor-pointer transition-colors">
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-bold text-[#111318]">Team Delta</span>
                  ...
                  <div className="p-4 hover:bg-background-light rounded-lg flex flex-col gap-2 cursor-pointer transition-colors">
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-bold text-[#111318]">The Web Wizards</span>
                ...
                <div className="p-4 border-t border-[#f0f2f4]">
                  <button className="w-full py-2 text-xs font-bold text-[#616f89] hover:text-[#111318] transition-colors">
                    Review All Group Scores
                  </button>
                </div>
              </div>
              <div className="bg-white rounded-xl border border-[#e5e7eb] p-6">
                <h3 className="text-sm font-bold mb-5 text-[#111318]">Semester Overview</h3>
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-[#f0f2f4]">
                    ...
                    <div className="w-full bg-[#f0f2f4] h-1.5 rounded-full overflow-hidden">
