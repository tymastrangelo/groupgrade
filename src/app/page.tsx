...
export default function Home() {
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-white">
      {/* Navigation Bar */}
      <header className="sticky top-0 z-50 w-full border-b border-solid border-[#dbdfe6] bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-[1200px] items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold tracking-tight text-[#111318]">GroupGrade</h2>
          </div>

          {/* Center Nav Links */}
          <div className="hidden md:flex flex-1 items-center justify-center gap-12">
            <a className="text-sm font-medium hover:text-primary transition-colors text-[#111318]" href="#features">Features</a>
            <a className="text-sm font-medium hover:text-primary transition-colors text-[#111318]" href="#how-it-works">How it works</a>
            <a className="text-sm font-medium hover:text-primary transition-colors text-[#111318]" href="#pricing">Pricing</a>
          </div>

          {/* Right Buttons */}
          <div className="flex items-center gap-4">
            <Link href="/auth/signin" className="hidden sm:flex min-w-[100px] items-center justify-center rounded-lg h-10 px-4 bg-transparent border border-[#dbdfe6] text-sm font-bold text-[#111318] hover:bg-white/10">
              Log In
            </Link>
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-[1200px] px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col gap-8 text-left max-w-2xl">
                ...
                <h1 className="text-[#111318] text-5xl font-black leading-[1.1] tracking-tight md:text-6xl">
                  Group projects, <br />
                  <span className="text-primary">without the chaos.</span>
                </h1>
                <p className="text-[#616f89] text-lg md:text-xl font-normal leading-relaxed">
              ...
              <div className="relative hidden lg:block">
                <div className="aspect-square rounded-3xl bg-primary/5 border border-primary/10 p-8 flex items-center justify-center">
                  <div className="w-full h-full rounded-2xl bg-white shadow-2xl p-6 border border-[#dbdfe6]">
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="h-20 rounded-lg bg-gray-50"></div>
                        <div className="h-20 rounded-lg bg-gray-50"></div>
                      </div>
        ...
        {/* Features Section */}
        <section className="bg-background-light[#0b101a] py-20" id="features">
          <div className="mx-auto max-w-[1200px] px-6">
            <div className="mb-16">
              <h2 className="text-[#111318] text-3xl font-bold md:text-4xl mb-4">Why GroupGrade?</h2>
              <p className="text-[#616f89] text-lg max-w-2xl">Built to eliminate the friction in team assignments and promote collaborative excellence.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              {/* Feature 1 */}
              <div className="flex flex-col gap-6 rounded-2xl border border-[#dbdfe6] bg-white p-8 hover:shadow-xl hover:shadow-primary/5 transition-all">
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-blue-50/10 text-primary">
                  <span className="material-symbols-outlined text-3xl">check_circle</span>
                </div>
                <div className="flex flex-col gap-2">
                  <h3 className="text-xl font-bold text-[#111318]">Accountability</h3>
                  <p className="text-[#616f89] leading-relaxed">Peer-driven check-ins that keep everyone on track and prevent the &quot;lazy teammate&quot; syndrome from day one.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6 rounded-2xl border border-[#dbdfe6] bg-white p-8 hover:shadow-xl hover:shadow-primary/5 transition-all">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-xl font-bold text-[#111318]">Visibility</h3>
                  <p className="text-[#616f89] leading-relaxed">Real-time insights into who is doing what. Instructors and team leads see project velocity in clear, simple dashboards.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6 rounded-2xl border border-[#dbdfe6] bg-white p-8 hover:shadow-xl hover:shadow-primary/5 transition-all">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-xl font-bold text-[#111318]">Fair Grading</h3>
                  <p className="text-[#616f89] leading-relaxed">Data-backed evidence to help instructors grade individual effort accurately, based on actual task completion logs.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white py-20" id="how-it-works">
          <div className="mx-auto max-w-[1200px] px-6">
            <div className="text-center mb-16">
              <h2 className="text-[#111318] text-3xl font-bold md:text-4xl mb-4">How it works</h2>
              <p className="text-[#616f89] text-lg">Three simple steps to better collaborative grades.</p>
            </div>
            <div className="relative grid md:grid-cols-3 gap-12">
              ...
              <div className="relative z-10 flex flex-col items-center text-center gap-6">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-white border-4 border-primary text-primary shadow-lg">
                  <span className="material-symbols-outlined text-3xl font-bold">person_add</span>
                </div>
                <div className="flex flex-col gap-2">
                  <h3 className="text-xl font-bold text-[#111318]">Join Your Team</h3>
                  <p className="text-[#616f89]">Sign in with Google and link to your course project with a simple invite code.</p>
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center text-center gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-xl font-bold text-[#111318]">Track Progress</h3>
                  <p className="text-[#616f89]">Log your weekly tasks and provide constructive peer feedback throughout the semester.</p>
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center text-center gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-xl font-bold text-[#111318]">Get Fair Credit</h3>
                  <p className="text-[#616f89]">Submit your final report with a clear, visual record of all your project contributions.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-background-light border-t border-[#dbdfe6] py-12">
        <div className="mx-auto max-w-[1200px] px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-[#111318]">GroupGrade</span>
            </div>
